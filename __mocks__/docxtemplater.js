...
// constructor-like mock that matches how real docxtemplater is used (i.e. new Docxtemplater(zip, opts)
class DocxMock {
  constructor() {}
  ...
  getZip() {
    // returns a fixed Buffer("DOCX_OUT")
...
- DocxMock._setBehavior(false) -> render() succeeds */
